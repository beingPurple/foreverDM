...
###input: [char] goes to find the ingredients for cake
...
##########
###input: victorious, [char] goes to mix the ingredients together.
result: The action goes exceptionally well, with significant positive outcomes and limited negative outcomes.
...
##########
###input: [char] goes to turn on the ove, and then waits patiently for it to bake.
...
##########
###input: [char] then does their best to decorate it!
